import { ArrowRightIcon, PlayIcon, ZapIcon, CheckIcon, Link } from 'lucide-react';
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Empower your brand with AI-generated content that captivates and converts. Elevate your marketing game effortlessly.
                            </motion.p>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-400">
                                            Use anywhere - ads, posts, stories
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
